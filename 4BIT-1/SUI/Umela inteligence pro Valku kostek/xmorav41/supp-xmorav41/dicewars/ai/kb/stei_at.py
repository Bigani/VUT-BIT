...
class AI:
    ...
    def ai_turn(self, board, nb_moves_this_turn, nb_transfers_this_turn, nb_turns_this_game, time_left):
        sh.extract_features(self,board)
        if nb_transfers_this_turn + self.reserved_evacs < self.max_transfers:
            ...
            self.logger.debug(
                f'Already did {nb_transfers_this_turn}/{self.max_transfers} transfers, reserving {self.reserved_evacs} for evac, skipping further aggresive ones')
        ...
        if self.stage == 'evac':
            if nb_transfers_this_turn < self.max_transfers:
                ...
                self.logger.debug(
                    f'Already did {nb_transfers_this_turn}/{self.max_transfers} transfers, skipping further')
